...
const Navbar = () => {
  ...
  <div className="navbar bg-base-100 xl:w-10/12 mx-auto">
  ...
  <div className="navbar-end flex gap-4 font-bold">
    <p><LuShoppingCart /></p>
    <p>Login</p>
    <a className="btn rounded-2xl text-white bg-gradient-to-r from-indigo-600  to-purple-500">Get Started</a>
  </div>
</div>
